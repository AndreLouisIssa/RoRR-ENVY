...
---@alias MGReturns-ENVY*file userdata|table|string|fun(...): table
...
--]]
---@see MGReturns-ENVY.import_all to shallow copy into an environment
---@see MGReturns-ENVY.import_as_fallback to use the result as a fallback
...
--]]
---@see MGReturns-ENVY.export to share locals from the file
---@see MGReturns-ENVY.import_all like python's `import *`
---@see MGReturns-ENVY.import_as_fallback `import_all`, without shallow copy
---@param env table environment (typically a plugin)
---@param file MGReturns-ENVY*file path relative to plugin, absolute path, file handle, chunk function, or module table
...
--]]
---@see MGReturns-ENVY.import how it obtains the data from the file/module
---@see MGReturns-ENVY.import_as_fallback this, but without shallow copying.
---@see MGReturns-ENVY.import_as_shared*auto this, but writes fallback as well.
---@param env table environment (typically a plugin)
---@param file MGReturns-ENVY*file path relative to plugin, absolute path, file handle, chunk function, or module table
---@param fenv table? environment to give the function (not relevant if a module table was given)
---@param level integer? stack level to send errors to <br/>
function envy.import_all(env,file,fenv,level,...) end
---@alias MGReturns-ENVY.import_all ...
...
--]]
---@see MGReturns-ENVY.import how it obtains the data from the file/module
---@see MGReturns-ENVY.import_all this, but by shallow copying.
---@param env table environment (typically a plugin)
---@param file MGReturns-ENVY*file path relative to plugin, absolute path, file handle, chunk function, or module table
---@param fenv table? environment to give the function (not relevant if a module table was given)
---@param level integer? stack level to send errors to <br/>
function envy.import_as_fallback(env,file,fenv,level,...) end
---@alias MGReturns-ENVY.import_as_fallback ...
...
---@see MGReturns-ENVY.import how it obtains the data from the file/module
---@see MGReturns-ENVY.import_all this, but by shallow copying.
---@see MGReturns-ENVY.import_as_shared this, but writes don't fallback.
---@param env table environment (typically a plugin)
---@param file MGReturns-ENVY*file path relative to plugin, absolute path, file handle, chunk function, or module table
---@param fenv table? environment to give the function (not relevant if a module table was given)
---@param level integer? stack level to send errors to <br/>
function envy.import_as_shared(env,file,fenv,level,...) end
---@alias MGReturns-ENVY.import_as_shared ...
...
--[[
    ...
    Usage:
        ...
        import_all(_ENV,ext)
--]]
---@class MGReturns-ENVY*extras: table
---@field public import fun(file: MGReturns-ENVY*file, fenv: table?,...): table loads a lua file/module relative to *your* plugin.
---@field public import_all fun(file: MGReturns-ENVY*file, fenv: table?,...) uses `import` to get the data from a lua file/module (shallow copied into *your* environment).
---@field public import_as_shared fun(file: MGReturns-ENVY*file, fenv: table?,...) uses `import` to get the data from a lua file/module (as fallback to *your* environment).
---@field public import_as_fallback fun(file: MGReturns-ENVY*file, fenv: table?,...) uses `import` to get the data from a lua file/module (as a fallback with linked writes from *your* environment).
...
--[[
    ...
    *   -   -   -   -   -   -   -   -
        ...
        import_all(_ENV,ext)
--]]
---@see MGReturns-ENVY*extras
---@see MGReturns-ENVY.auto
---@see MGReturns-ENVY.import_all
---@return table newenv
---@return MGReturns-ENVY*extras extras
function envy.setup(env) end
---@alias MGReturns-ENVY.setup ...
...
--]]
---@see MGReturns-ENVY*extras
---@see MGReturns-ENVY.setup
---@see MGReturns-ENVY.import
---@param level integer?
---@return MGReturns-ENVY*extras extras
function envy.auto(level) end
---@alias MGReturns-ENVY.auto ...
