...
--]]
---@see MGReturns-ENVY-auto.export to share locals from the file
---@see MGReturns-ENVY-auto.import_all like python's `import *`
---@see MGReturns-ENVY-auto.import_as_fallback `import_all`, without shallow copy
...
---@alias MGReturns-ENVY-auto.import ...
...
--[[
    ...
    Usage:
        import_all("util.lua")
--]]
---@see MGReturns-ENVY-auto.import how it obtains the data from the file/module
---@see MGReturns-ENVY-auto.import_as_fallback this, but without shallow copying.
---@param file MGReturns-ENVY*file path relative to plugin, absolute path, file handle, chunk function, or module table
---@param fenv table? environment to give the function (not relevant if a module table was given)
---@param ... any arguments passed in to the chunk function (if relevant) <br/>
function import_all(file,fenv,...) end
---@alias MGReturns-ENVY-auto.import_all ...
...
--]]
---@see MGReturns-ENVY-auto.import how it obtains the data from the file/module
---@see MGReturns-ENVY-auto.import_all this, but by shallow copying.
---@see MGReturns-ENVY-auto.import_as_shared this, but writes fallback as well.
---@param file MGReturns-ENVY*file path relative to plugin, absolute path, file handle, chunk function, or module table
---@param fenv table? environment to give the function (not relevant if a module table was given)
---@param ... any arguments passed in to the chunk function (if relevant) <br/>
function import_as_fallback(file,fenv,...) end
---@alias MGReturns-ENVY-auto.import_as_fallback ...
...
---@see MGReturns-ENVY-auto.import how it obtains the data from the file/module
---@see MGReturns-ENVY-auto.import_all this, but by shallow copying.
---@see MGReturns-ENVY-auto.import_as_shared this, but writes don't fallback.
---@param file MGReturns-ENVY*file path relative to plugin, absolute path, file handle, chunk function, or module table
---@param fenv table? environment to give the function (not relevant if a module table was given)
---@param ... any arguments passed in to the chunk function (if relevant) <br/>
function import_as_shared(file,fenv,...) end
---@alias MGReturns-ENVY-auto.import_as_shared*auto ...
...
--]]
---@see MGReturns-ENVY-auto.import_all to shallow copy into an environment
---@see MGReturns-ENVY-auto.import_as_fallback to use the result as a fallback
...
---@alias MGReturns-ENVY-auto.export ...
